	...
	Menu2_3=new Array("Помощь в решении контрольных и курсовых работ","#","",2,35,220);
		Menu2_3_1=new Array("Математика","#","",2,20,220);
			...
			Menu2_3_1_2=new Array("Примеры решения задач","#","",5,20,220);
				Menu2_3_1_2_1=new Array("Линейная алгебра, аналитическая геометрия, пределы, производная","8a.doc","",0,35,220);
				Menu2_3_1_2_2=new Array("ФНП, интегралы, дифференциальные уравнения","8b.doc","",0,35,220);
				Menu2_3_1_2_3=new Array("Двойные, тройные, криволинейные интегралы, элеметы теории поля, ряды","8c.doc","",0,50,220);
				Menu2_3_1_2_4=new Array("ТВиМС, математическое программирование","8d.doc","",0,35,220);
				Menu2_3_1_2_5=new Array("ЭММ","8e.doc","",0,20,220);
		Menu2_3_2=new Array("Информатика и программирование","#","",1,20,220);
			Menu2_3_2_1=new Array("Примеры решения задач","9.doc","",0,20,220);
...
Menu3=new Array("Абитуриентам","#","",3);
	...
	Menu3_3=new Array("примеры ЦТ (Проверь себя)","#","",4,20,280);
		Menu3_3_1=new Array("Тест 1 (Легкий)","3.doc","",0,20,220);
		Menu3_3_2=new Array("Тест 2 (Средний)","4.doc","",0,20,220);
		Menu3_3_3=new Array("Тест 3 (Продвинутый)","5.doc","",0,20,220);
		Menu3_3_4=new Array("Ответы к тестам","6.doc","",0,20,220);
